export function stringToDom(htmlString) {
    ...
    return tempNode.childNodes.length ? tempNode.childNodes : null;
}
...
export function mapEvent(eventName){
    const eventReplace =  eventReplacement[eventName];
    const validEvent = typeof window['on' + eventReplace] === 'object' ? eventReplace : eventName; 
    return validEvent
}
